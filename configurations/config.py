...
# from encoders import Encoder_tloc
from configurations.config_script import *
...
tloc_data_path = folder_tloc_data + "/data_2g.csv"
###############################################################################################
...
model_encoder_trained = RandomForestRegressor(n_jobs=-1,n_estimators=100,max_features='sqrt')
# model_encoder_trained = Encoder_tloc(n_jobs=-1,n_estimators=100,max_features='sqrt')
# if prior_flag:
...
#       path_KNetLatent_trained = folder_KNetLatent_models + 'KNatLatent_optimal_' + "Lorenz" + '_' + 'Baseline_fix_enc_' + str(int(fix_encoder_flag)) + '_r_' + str(real_r2) + '.pt'