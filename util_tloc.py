...
def compute_relative_feature(data):
    ...
    column=['Lon2_re','Lat2_re','Lon3_re','Lat3_re','Lon4_re','Lat4_re','Lon5_re','Lat5_re','Lon6_re','Lat6_re',
           'AsuLevel_1','SignalLevel_1','AsuLevel_2','SignalLevel_2','AsuLevel_3','SignalLevel_3',
           'AsuLevel_4','SignalLevel_4','AsuLevel_5','SignalLevel_5','AsuLevel_6','SignalLevel_6',
           're_ID_x_2', 're_ID_x_3','re_ID_x_4','re_ID_x_5','re_ID_x_6',
           're_ID_y_2', 're_ID_y_3','re_ID_y_4','re_ID_y_5','re_ID_y_6',]
...
def ext_feat_and_label(domain_data):
    label = domain_data[['re_lon', 're_lat']].values
    feature = compute_relative_feature(domain_data).values
