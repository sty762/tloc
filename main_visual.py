...
from data_initialization import initialize_data_TLoc
import matplotlib.pyplot as plt
import time

############## checking only encoder loss (not depand on seed) ####################################
train_loader,val_loader,test_loader,train_input, train_target, cv_input, cv_target, test_input, test_target = initialize_data_TLoc(path_for_states, path_for_observations, batch_size, prior_r2, real_r2, dev, warm_start_flag)
...
if dataset_name == "Pendulum":
    ...
    for i,r in enumerate(r_values):
        ...
        print("Encoder + Prior loss: {}".format(10 * math.log10(loss[0])))
